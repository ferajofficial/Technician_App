...
class NormalBookingView extends StatefulWidget {
  const NormalBookingView({Key? key}) : super(key: key);

  @override
  State<NormalBookingView> createState() => _NormalBookingViewState();
}

class _NormalBookingViewState extends State<NormalBookingView> {
  @override
